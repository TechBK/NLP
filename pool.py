...
class Pool(object):
    def __init__(self):
        self.__document_classes = {}            #dictionaries of document in a class
        self.__vocabulary = BagOfWords()        #dictionaries of word in a class
    ...
    def test(self):
        document_class = self.__document_classes["clinton"]
        bag = document_class.WordsAndFreq()
        #print(bag)
